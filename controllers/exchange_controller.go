...
func (r *ExchangeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		r.Recorder.Event(exchange, corev1.EventTypeWarning, "FailedUpdate", msg)
		logger.Error(err, msg)
		return ctrl.Result{}, err
	}

	rabbitClient, err := r.RabbitmqClientFactory(ctx, r.Client, exchange.Spec.RabbitmqClusterReference, exchange.Namespace, systemCertPool)
