...
func (r *PolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	rmq, err := internal.ParseRabbitmqClusterReference(ctx, r.Client, policy.Spec.RabbitmqClusterReference, policy.Namespace)
	...
	credentialsProvider, svc, err := r.ClusterCredentialsProvider.GetCredentialsProvider(ctx, policy.Namespace, rmq)
	if err != nil {
		return reconcile.Result{}, err
	}
