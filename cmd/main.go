...
func main() {
	...
	if err = (&controller.TopologyReconciler{
		...
		Recorder:                mgr.GetEventRecorder(controller.QueueControllerName),
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.ExchangeList{},
		Log:                     ctrl.Log.WithName(controller.ExchangeControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.ExchangeControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.BindingList{},
		Log:                     ctrl.Log.WithName(controller.BindingControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.BindingControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		APIReader:               mgr.GetAPIReader(),
		Type:                    &topology.Vhost{},
		ListType:                &topology.VhostList{},
		Log:                     ctrl.Log.WithName(controller.VhostControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.VhostControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.PolicyList{},
		Log:                     ctrl.Log.WithName(controller.PolicyControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.PolicyControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.OperatorPolicyList{},
		Log:                     ctrl.Log.WithName(controller.OperatorPolicyControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.OperatorPolicyControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.PermissionList{},
		Log:                     ctrl.Log.WithName(controller.PermissionControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.PermissionControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.SchemaReplicationList{},
		Log:                     ctrl.Log.WithName(controller.SchemaReplicationControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.SchemaReplicationControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.FederationList{},
		Log:                     ctrl.Log.WithName(controller.FederationControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.FederationControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.ShovelList{},
		Log:                     ctrl.Log.WithName(controller.ShovelControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.ShovelControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.TopologyReconciler{
		...
		ListType:                &topology.TopicPermissionList{},
		Log:                     ctrl.Log.WithName(controller.TopicPermissionControllerName),
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.TopicPermissionControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		KubernetesClusterDomain: clusterDomain,
	...
	if err = (&controller.SuperStreamReconciler{
		...
		Scheme:                  mgr.GetScheme(),
		Recorder:                mgr.GetEventRecorder(controller.SuperStreamControllerName),
		RabbitmqClientFactory:   rabbitmqclient.RabbitholeClientFactory,
		MaxConcurrentReconciles: maxConcurrentReconciles,
	}).SetupWithManager(mgr); err != nil {
