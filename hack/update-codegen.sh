...
mkdir -p api/rabbitmq.com/v1beta2
cp api/v1beta2/* api/rabbitmq.com/v1beta2/
...
# Kubebuilder project layout has api under 'api/v1beta2'
# client-go codegen expects group name in the path ie. 'api/rabbitmq.com/v1beta2'
...
xargs sed -i".out" -e "s#github.com/rabbitmq/messaging-topology-operator/api/rabbitmq.com/v1beta2#github.com/rabbitmq/messaging-topology-operator/api/v1beta2#g"
