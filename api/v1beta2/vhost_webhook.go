...
// +kubebuilder:webhook:verbs=create;update,path=/validate-rabbitmq-com-v1beta2-vhost,mutating=false,failurePolicy=fail,groups=rabbitmq.com,resources=vhosts,versions=v1beta2,name=vvhost.kb.io,sideEffects=none,admissionReviewVersions=v1
