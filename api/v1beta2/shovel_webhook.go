...
// +kubebuilder:webhook:verbs=create;update,path=/validate-rabbitmq-com-v1beta2-shovel,mutating=false,failurePolicy=fail,groups=rabbitmq.com,resources=shovels,versions=v1beta2,name=vshovel.kb.io,sideEffects=none,admissionReviewVersions=v1
