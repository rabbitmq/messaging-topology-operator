...
// +kubebuilder:webhook:verbs=create;update,path=/validate-rabbitmq-com-v1beta2-user,mutating=false,failurePolicy=fail,groups=rabbitmq.com,resources=users,versions=v1beta2,name=vuser.kb.io,sideEffects=none,admissionReviewVersions=v1
