...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (r *RabbitmqClusterReference) DeepCopyInto(out *RabbitmqClusterReference) {
	*out = *r
	if r.ConnectionSecret != nil {
		in, out := &r.ConnectionSecret, &out.ConnectionSecret
		*out = new(v1.LocalObjectReference)
		**out = **in
	}
}
...
func (r *RabbitmqClusterReference) DeepCopy() *RabbitmqClusterReference {
	if r == nil {
		return nil
	}
