...
type TopicPermissionSpec struct {
	...
	// foo is an example field of TopicPermission. Edit topicpermission_types.go to remove/update
	// +optional
...
type TopicPermissionStatus struct {
	...
	// conditions represent the current state of the TopicPermission resource.
...
type TopicPermission struct {
	...
	// spec defines the desired state of TopicPermission
	// +required
	Spec TopicPermissionSpec `json:"spec"`

	// status defines the observed state of TopicPermission
	// +optional
	Status TopicPermissionStatus `json:"status,omitzero"`
}
