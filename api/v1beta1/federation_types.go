...
type FederationSpec struct {
	...
	// foo is an example field of Federation. Edit federation_types.go to remove/update
	// +optional
...
type FederationStatus struct {
	...
	// conditions represent the current state of the Federation resource.
...
type Federation struct {
	...
	// spec defines the desired state of Federation
	// +required
	Spec FederationSpec `json:"spec"`

	// status defines the observed state of Federation
	// +optional
