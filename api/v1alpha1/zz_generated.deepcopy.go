...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SuperStreamValidator) DeepCopyInto(out *SuperStreamValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SuperStreamValidator.
func (in *SuperStreamValidator) DeepCopy() *SuperStreamValidator {
	if in == nil {
		return nil
	}
	out := new(SuperStreamValidator)
	in.DeepCopyInto(out)
	return out
}
