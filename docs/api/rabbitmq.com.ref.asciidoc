...
|===
| Field | Description
| *`superStreamReference`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamreference[$$SuperStreamReference$$]__ | Reference to the SuperStream that the SuperStreamConsumer will consume from Required property.
| *`consumerPodSpec`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerpodspec[$$SuperStreamConsumerPodSpec$$]__ | 
|===
