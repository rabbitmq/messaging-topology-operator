...
- xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumer[$$SuperStreamConsumer$$]
- xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerlist[$$SuperStreamConsumerList$$]
...
- xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerstatus[$$SuperStreamConsumerStatus$$]
...
[id="{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumer"]
==== SuperStreamConsumer 
...
| *`spec`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerspec[$$SuperStreamConsumerSpec$$]__ | 
| *`status`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerstatus[$$SuperStreamConsumerStatus$$]__ | 
|===


[id="{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerlist"]
...
| *`items`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumer[$$SuperStreamConsumer$$]__ | 
|===


[id="{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerpodspec"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerspec[$$SuperStreamConsumerSpec$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`default`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#podspec-v1-core[$$PodSpec$$]__ | Default defines the PodSpec to use for all consumer Pods, if no routing key-specific PodSpec is provided.
| *`perRoutingKey`* __object (keys:string, values:link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#podspec-v1-core[$$PodSpec$$])__ | PerRoutingKey maps PodsSpecs to specific routing keys. If a consumer is spun up for a SuperStream partition, and the routing key for that partition matches an entry in PerRoutingKey, that PodSpec will be used for the consumer Pod; otherwise the default PodSpec is used.
|===


[id="{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerspec"]
...
|===
| Field | Description
| *`superStreamReference`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamreference[$$SuperStreamReference$$]__ | Reference to the SuperStream that the SuperStreamConsumer will consume from, in the same namespace. Required property.
| *`consumerPodSpec`* __xref:{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerpodspec[$$SuperStreamConsumerPodSpec$$]__ | ConsumerPodSpec defines the PodSpecs to use for any consumer Pods that are created for the SuperStream.
|===


[id="{anchor_prefix}-github-com-rabbitmq-messaging-topology-operator-api-v1beta1-superstreamconsumerstatus"]
