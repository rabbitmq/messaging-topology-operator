...
// +kubebuilder:rbac:groups=rabbitmq.com.rabbitmq.com,resources=vhosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rabbitmq.com.rabbitmq.com,resources=vhosts/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=rabbitmq.com.rabbitmq.com,resources=vhosts/finalizers,verbs=update
