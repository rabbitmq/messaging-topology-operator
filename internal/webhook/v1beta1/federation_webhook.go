...
func (v *FederationCustomValidator) ValidateCreate(ctx context.Context, fed *rabbitmqcomv1beta1.Federation) (warnings admission.Warnings, err error) {
...
func (v *FederationCustomValidator) ValidateUpdate(ctx context.Context, oldFederation, newFederation *rabbitmqcomv1beta1.Federation) (warnings admission.Warnings, err error) {
	...
	if err := validateSecretLabel(ctx, v.Client, v.APIReader, newFederation.Spec.UriSecret, newFederation.Namespace); err != nil {
		return nil, err
	}
	return nil, nil
}
