...
func (c *policies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Policy, err error) {
	result = &v1beta1.Policy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("policies").
		Name(name).
...
func (c *policies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PolicyList, err error) {
...
func (c *policies) Create(ctx context.Context, policy *v1beta1.Policy, opts v1.CreateOptions) (result *v1beta1.Policy, err error) {
	result = &v1beta1.Policy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policies").
...
func (c *policies) Update(ctx context.Context, policy *v1beta1.Policy, opts v1.UpdateOptions) (result *v1beta1.Policy, err error) {
	result = &v1beta1.Policy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policies").
...
func (c *policies) UpdateStatus(ctx context.Context, policy *v1beta1.Policy, opts v1.UpdateOptions) (result *v1beta1.Policy, err error) {
	result = &v1beta1.Policy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policies").
...
func (c *policies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Policy, err error) {
	result = &v1beta1.Policy{}
