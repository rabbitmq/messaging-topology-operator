...
var policiesResource = schema.GroupVersionResource{Group: "rabbitmq.com", Version: "v1beta1", Resource: "policies"}

var policiesKind = schema.GroupVersionKind{Group: "rabbitmq.com", Version: "v1beta1", Kind: "Policy"}
...
func (c *FakePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(policiesResource, c.ns, name), &v1beta1.Policy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Policy), err
}

// List takes label and field selectors, and returns the list of Policies that match those selectors.
func (c *FakePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(policiesResource, policiesKind, c.ns, opts), &v1beta1.PolicyList{})
	...
	list := &v1beta1.PolicyList{ListMeta: obj.(*v1beta1.PolicyList).ListMeta}
	for _, item := range obj.(*v1beta1.PolicyList).Items {
...
func (c *FakePolicies) Create(ctx context.Context, policy *v1beta1.Policy, opts v1.CreateOptions) (result *v1beta1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(policiesResource, c.ns, policy), &v1beta1.Policy{})
...
func (c *FakePolicies) Update(ctx context.Context, policy *v1beta1.Policy, opts v1.UpdateOptions) (result *v1beta1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(policiesResource, c.ns, policy), &v1beta1.Policy{})
...
func (c *FakePolicies) UpdateStatus(ctx context.Context, policy *v1beta1.Policy, opts v1.UpdateOptions) (*v1beta1.Policy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(policiesResource, "status", c.ns, policy), &v1beta1.Policy{})
...
func (c *FakePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(policiesResource, c.ns, name, opts), &v1beta1.Policy{})
...
func (c *FakePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.PolicyList{})
	return err
}
...
func (c *FakePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(policiesResource, c.ns, name, pt, data, subresources...), &v1beta1.Policy{})
