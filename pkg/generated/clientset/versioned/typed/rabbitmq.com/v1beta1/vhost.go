...
func (c *vhosts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Vhost, err error) {
	result = &v1beta1.Vhost{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vhosts").
		Name(name).
...
func (c *vhosts) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VhostList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.VhostList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vhosts").
...
func (c *vhosts) Create(ctx context.Context, vhost *v1beta1.Vhost, opts v1.CreateOptions) (result *v1beta1.Vhost, err error) {
	result = &v1beta1.Vhost{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vhosts").
...
func (c *vhosts) Update(ctx context.Context, vhost *v1beta1.Vhost, opts v1.UpdateOptions) (result *v1beta1.Vhost, err error) {
	result = &v1beta1.Vhost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vhosts").
...
func (c *vhosts) UpdateStatus(ctx context.Context, vhost *v1beta1.Vhost, opts v1.UpdateOptions) (result *v1beta1.Vhost, err error) {
	result = &v1beta1.Vhost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vhosts").
...
func (c *vhosts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Vhost, err error) {
	result = &v1beta1.Vhost{}
