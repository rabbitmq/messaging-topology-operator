	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RabbitmqV1alpha2().Vhosts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RabbitmqV1alpha2().Vhosts(namespace).Watch(context.TODO(), options)
			},
		},
		&rabbitmqcomv1alpha2.Vhost{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vhostInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rabbitmqcomv1alpha2.Vhost{}, f.defaultInformer)
}

func (f *vhostInformer) Lister() v1alpha2.VhostLister {
	return v1alpha2.NewVhostLister(f.Informer().GetIndexer())
}
