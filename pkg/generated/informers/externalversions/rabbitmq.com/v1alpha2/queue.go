	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RabbitmqV1alpha2().Queues(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RabbitmqV1alpha2().Queues(namespace).Watch(context.TODO(), options)
			},
		},
		&rabbitmqcomv1alpha2.Queue{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *queueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rabbitmqcomv1alpha2.Queue{}, f.defaultInformer)
}
